...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull RelativeLayout rootView, @NonNull ImageView ivLogo,
      @NonNull ProgressBar progressBar, @NonNull TextView tvAppName, @NonNull TextView tvLoading,
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((RelativeLayout) rootView, ivLogo, progressBar, tvAppName,
          tvLoading, tvTagline, tvVersion);
    }
